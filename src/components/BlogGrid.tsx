...
},
{
  ...
  paragraphs: [
    ...
    { text: "Organizations often believe they are maturing because they are producing more dashboards, automations, or centralized activity. But maturity is not defined by output — it's defined by whether the infrastructure enables work to compound across the organization." },
    ...
    { label: "Centralized Chaos:", text: "The most dangerous stage because it feels like progress. Teams are reorganized and resources are consolidated, but the underlying data silos persist — SQL Server here, Oracle there, spreadsheets everywhere. Technical fragmentation remains unresolved, and complexity increases as teams try to reconcile systems that were never designed to work together." },
    ...
    { label: "Strategic Data Architecture:", text: "Data becomes infrastructure. Teams build on a shared platform — whether Snowflake, Databricks, Fabric, or similar — that eliminates architectural fragmentation. Pipelines, transformations, and governance layer on top of a single source of truth, enabling systems to be reusable, consistent, and scalable across the organization without reconciliation overhead." },
...
},
{
  ...
  paragraphs: [
    ...
    { text: "That gap is where most data transformations fail — not because of governance policies or org design, but because they never consolidated the technical architecture that makes those things work well together." },
  ],
},
];
