...
export const projects: Project[] = [
  ...
  },
  {
    ...
    results: "Helped preserve reporting and automation continuity during a high-impact platform migration while improving visibility into upstream and downstream dependencies. The project also exposed how much business logic was duplicated across Power BI reports and automation workflows, which led me to begin consolidating the transformation logic into reusable Snowflake views and establishing a more centralized, maintainable semantic layer for future development.",
