...
export const projects: Project[] = [
  {
    ...
    tags: ["Reusable Datasets", "Data Consistency", "SQL Refactoring", "Cloud Platform Migration", "Data Standardization"],
    featured: true
  },
  {
    id: 2,
    ...
    tags: ["Data Governance", "Python GUI App", "Audit Trail", "Self-Service Analytics Solution", "Automated ETL Pipeline"],
    featured: true
  },
  {
    id: 3,
  title: "From Fragmented Metrics to Decision Intelligence: A Maturity Framework",
  ...
  },
{
    ...
    tags: ["Unified Cloud Platform", "Data Scalability", "Semantic Models", "Dimensional Data Models", "Metrics Dashboard"],
    featured: true
  }
];
