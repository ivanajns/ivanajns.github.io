...
export const projects: Project[] = [
  {
    ...
    tags: ["Reusable Architecture", "Generative AI", "SQL Refactoring", "Inventory Mgmt", "Cloud Platform", "Data Standardization"],
    featured: true
  },
  {
    id: 2,
    ...
    tags: ["Self-Service Analytics", "Python Application", "Audit Trail", "SQL Querying", "ETL Pipeline", "Data Governance"],
    featured: true
  },
  {
    id: 3,
