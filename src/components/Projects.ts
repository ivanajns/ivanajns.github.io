...
export const projects: Project[] = [
  {
    ...
    tags: ["Reusable Analytics", "Snowflake", "Generative AI", "SQL Refactoring", "Inventory Audit", "Power BI", "Transformation Layer"],
    featured: true
  },
  {
    id: 2,
    ...
    tags: ["Self-Service Analytics", "Python-based application", "SQL Database", "Audit Trail", "Data Governance"],
    featured: true
  },
  {
    id: 3,
  ...
  },
{
    ...
    tags: ["Unified Analytics Platform", "Microsoft Fabric", "Power BI", "Dimensional Data Modeling", "Semantic Modeling"],
    featured: true
  }
];
